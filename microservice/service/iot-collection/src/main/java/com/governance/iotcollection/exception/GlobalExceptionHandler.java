...
public class GlobalExceptionHandler extends AbstractGlobalExceptionHandler {
    ...
    @ExceptionHandler(DuplicateIotCollectionTaskException.class)
    public ResponseEntity<ApiResponse<Void>> handleDuplicateIotCollectionTask(DuplicateIotCollectionTaskException ex) {
